export const Projects = [
  ...
  },
  {
    ...
    title: "Taskify",
    description:
      "Taskify is an application that was built with the purpose of helping developers plan and organize tasks for their future project (something similar to Trello). My colleague and I came up with the idea for this kind of application as an exercise in order to face various problems and thus learn more. We used tools like NextJS, Tailwindcss, MongoDB and Typesript.",
    shortDescription:
